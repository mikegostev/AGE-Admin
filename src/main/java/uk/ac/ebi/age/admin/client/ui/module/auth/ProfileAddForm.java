...
public class ProfileAddForm extends DynamicForm
{
 public ProfileAddForm( DataSource dataSource, final CloseClickHandler clsHnd )
 {
  setMargin(20);
...
//  form.setUseAllDataSourceFields(true);  
  ...
  header.setDefaultValue("New Profile");  

  TextItem idField = new TextItem();
  idField.setName(ProfileDSDef.profIdField.getFieldId());
  idField.setTitle(ProfileDSDef.profIdField.getFieldTitle());  
  idField.setRequired(true);  
  
  TextItem nameField = new TextItem();
  nameField.setName(ProfileDSDef.profDescField.getFieldId());
  nameField.setTitle(ProfileDSDef.profDescField.getFieldTitle());  
