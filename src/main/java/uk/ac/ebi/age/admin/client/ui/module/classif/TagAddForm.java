...
public class TagAddForm extends DynamicForm
{
 public TagAddForm( DataSource dataSource, String parent, final CloseClickHandler clsHnd )
 {
  setMargin(20);
...
//  form.setUseAllDataSourceFields(true);  
  ...
  header.setDefaultValue("New Tag");  

  HiddenItem prnt = new HiddenItem();
  prnt.setName(TagsDSDef.parentField.getFieldId());
  prnt.setValue(parent);
  
  TextItem idField = new TextItem();
  idField.setName(TagsDSDef.idField.getFieldId());
  idField.setTitle(TagsDSDef.idField.getFieldTitle());  
  idField.setRequired(true);  
  
  TextItem nameField = new TextItem();
  nameField.setName(TagsDSDef.descField.getFieldId());
  nameField.setTitle(TagsDSDef.descField.getFieldTitle());  
  ...
  form.setFields(header, idField, nameField, sp,  addItem, cancelItem, prnt);  
 }
