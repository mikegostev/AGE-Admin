...
public class Init implements ServletContextListener
{
 ...
 public void contextInitialized(ServletContextEvent arg0)
 {
  ...
  AgeViewConfigManager cfg = new AgeViewConfigManager( arg0.getServletContext() );

  AgeViewConfigManager.setInstance(cfg);
 ...
 {
  AgeViewService service = AgeViewService.getInstance();
  ...
  if( AgeViewConfigManager.instance().isMaster() )
